    ...
    <div class="align-middle  min-w-full  overflow-hidden   px-3 md:px-8 pt-3 rounded-bl-lg rounded-br-lg">
        <table class="min-w-full">
            ...
            <tbody class="bg-white">
                {#each chapter.dpp_tests as test}
                <tr>
                    ...
                    <td class="px-2 md:px-6 py-4 whitespace-no-wrap text-right border-b  text-xs md:text-sm leading-5">
                        <a href="/tests/dpp_test_report/{test._id}" class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">View</a> 
                    </td>
          </tr>
