<script>
  ...
  import TopStudentDaisy from "../../../../lib/components/navigation_bars/top_student_daisy.svelte";
    ...
    import ResultQuestions from "../../../../lib/components/Lists/modern/dpp_result_questions.svelte";
  ...
  onMount(async () => {
    ...
    console.log(loginPath+'/auth/whoami abcdef');
    const res = await fetch(
      loginPath + "/user/students/dpp_test_result_with_questions/" + resultId,
      {
        mode: "cors",
        method: "get",
