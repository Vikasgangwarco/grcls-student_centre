        ...
        <div class="container flex flex-col flex-1 px-6 py-12 mx-auto">
            <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
                <div class="text-white lg:w-1/2 lg:mx-6">
                    <h1 class="text-2xl font-semibold capitalize lg:text-3xl">Contact us for <br> more info</h1>
                    ...
                    <p class="flex items-start mt-6 mx-2 my-2">
                      ...
                      9A Shahnajaf Road,Opp. Saint <br>
                      Francis College, Hazratganj, <br>
                      Lucknow
                      </span>
                      
                      </p>

                      <p class="flex items-start mx-2 my-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-blue-500 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>
                        
                        <span class="mx-2  truncate w-72 ">840-000-2983</span>
                        </p>
                ...
                <div class="mt-5 lg:w-1/2 lg:mx-6">
                    <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                        ...
                        <form class="mt-6">
                            ...
                            <div class="flex-1 mt-6">
                                <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Contact Number</label>
                                <input type="email" placeholder="9884567899" class="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                            </div>
...
<section class="bg-white dark:bg-gray-900">
  <div class="container grid grid-cols-1 gap-10 px-6 py-12 mx-auto lg:grid-cols-3">
      <div>
          ...
          <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Visit our branches</h1>
      ...
      <div class="grid grid-cols-1 gap-12 lg:col-span-2 sm:grid-cols-2">
          <div>
              <h2 class="font-medium text-gray-800 dark:text-white">Indira Nagar Branch</h2>
              <p class="mt-2 text-gray-500 dark:text-gray-400">D-3221, Indira Nagar Near Munshipulia,<br> Lucknow</p>
          </div>

          <div>
              <h2 class="font-medium text-gray-800 dark:text-white"> Gomti Nagar Branch</h2>
              <p class="mt-2 text-gray-500 dark:text-gray-400">New Address: The Avadh School 5 & 6 Vipul Khand Gomti Nagar , Lucknow</p>
          </div>

          <div>
              <h2 class="font-medium text-gray-800 dark:text-white">Kapoorthla Branch</h2>
              <p class="mt-2 text-gray-500 dark:text-gray-400">B1/8, 3rd Floor, ved Plaza, Sector- F Rd, above Trends, Kapoorthla, Lucknow</p>
          </div>

          <div>
              <h2 class="font-medium text-gray-800 dark:text-white">Ansal Branch</h2>
              <p class="mt-2 text-gray-500 dark:text-gray-400">742/4 Near Ansal Police Station Pocket 2 Sector-E, Lucknow</p>
          </div>

          <div>
              <h2 class="font-medium text-gray-800 dark:text-white">Alambagh Branch</h2>
              <p class="mt-2 text-gray-500 dark:text-gray-400">Shri Pratap Mall, Opp. Pheonix Mall Plot No.-KBC-6, Alambagh, Lucknow</p>
          </div>
