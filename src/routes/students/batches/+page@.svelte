<script>
  ...
  async function fetchSearch() {
    let dashboardReq = await fetch(panelPath + "/search/" + search, {
      method: "get",
  ...
  async function getDashboard() {
    let dashboardReq = await fetch(panelPath + "/dashboard", {
      method: "get",
      headers: { Authorization: "Bearer " + token },
    });
    dashboard = await dashboardReq.json();
...
{#if dashboard}
  <div class="w3-center rounded">
    ...
    <div class="ui search" style="cursor:pointer">
      <div class="ui icon input">
        <input
          class="prompt p-2 rounded bg-gray-200"
          type="text"
          bind:value={search}
  ...
  <div class="m-10">
    ...
    <p>
      See All <a class="w3-margin w3-link w3-text-cyan" href="/events">Events</a
      >
    </p>
    <hr />
    ...
    <p>
      See All <a class="w3-margin w3-link w3-text-cyan" href="/bookings"
        >Bookings</a
      >
    </p>
    <hr />
    ...
    <p>
      See All <a class="w3-margin w3-link w3-text-cyan" href="/users">Users</a>
    </p>
    <hr />
  </div>
...
<!-- <header>
        <ul>
         ...
         <nav class="bg-gray-800 p-2 mt-0 fixed w-full  top-0">
          <div class="container mx-auto flex flex-wrap items-center">
              <!-- <div class="flex w-full md:w-1/2 justify-center md:justify-start text-white font-extrabold">
                  <a class="text-white no-underline hover:text-white hover:no-underline" href="#">
                      <span class="text-2xl pl-2"><i class="em em-grinning"></i> abcd</span>
                  </a>
              </div> -->
...
<div class="px-20 pt-14">
  <div class="flex space-x-4 py-10">
    <input
      ...
      class="input input-bordered w-fit justify-end flex-1"
    />
  ...
  <div class="flex justify-center w-full py-2 gap-2">
    <a href="#item1" class="radio"
      ><input type="radio" name="radio-1" class="radio" checked /></a
    >
    <a href="#item2" class="radio"
      ><input type="radio" name="radio-1" class="radio" /></a
    >
    <a href="#item3" class="radio"
      ><input type="radio" name="radio-1" class="radio" /></a
    >
    <a href="#item4" class="radio"
      ><input type="radio" name="radio-1" class="radio" /></a
    >
  </div>
  ...
  <div class="card bg-base-100 shadow-xl bg-slate-400 my-16 p-3 w-1/3">
    <div class="flex">
      ...
      <p
        class="badge bg-amber-300 border-amber-300 text-black rounded-md h-7 mr-4"
      >
        New
      </p>
