...
<main class="mt-20">
  ...
  <section class="">
    <div class="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
      <div>
        <h2 class="text-3xl font-bold text-center sm:text-5xl">Our Batches</h2>
      ...
      <div class="grid gap-3 lg:gap-8 lg:grid-cols-4 lg:items-center">
        ...
        <article class="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm">
            ...
            <div class="p-4 sm:p-6">
              ...
              <a href="/view/batch/{batch._id}" class="group mt-4 inline-flex items-center gap-1 text-sm font-medium text-blue-600">
                Find out more
