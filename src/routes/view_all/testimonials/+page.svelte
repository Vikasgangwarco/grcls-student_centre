...
<section class="">
  <div class="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
    <div>
      <h2 class="text-3xl font-bold text-center sm:text-5xl">Our Testimonials</h2>
      ...
      <article class="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm">
          ...
          <div class="flex-shrink-0  ">
              <span class="self-center text-4xl">
                {@html decodeAndModifyImage(testimonial.image)}
              </span>
          </div>
          ...
          <div class="p-4 sm:p-6">
            ...
            <a href="/view/testimonial/{testimonial._id}" class="group mt-4 inline-flex items-center gap-1 text-sm font-medium text-blue-600">
              Find out more
