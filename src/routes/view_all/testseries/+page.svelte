<script>
  ...
  async function getTestSeries() {
    console.log("trying testseries");
    var token = localStorage.getItem("token");
    var res;
    var loginPath = get(ApiUrl);
    console.log("trying testseries2");
    ...
    if (res.status == 200) {
      try {
        ...
        if (response.status == "success") {
          ...
          // startIntervalTestSeries();
          console.log("testseries");
          console.log(testseries);
          console.log("testseries");
          // testseries= response.data.testseries;
        } else {
...
<section class="">
  <div class="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
    <div>
      <h2 class="text-3xl font-bold text-center sm:text-5xl">Our TestSeries</h2>
      <!-- <p class="max-w-3xl mx-auto mt-4 text-xl text-center ">Check Out all our Courses.</p> -->
    </div>
    <div class="grid gap-3 lg:gap-8 lg:grid-cols-4 lg:items-center">
      
      {#if testseries}
      {#each testseries as testseries}
      <article class="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm">
          ...
          <div class="flex-shrink-0  ">
              <span class="self-center text-4xl">
                {@html decodeAndModifyImage(testseries.image)}
              </span>
          </div>
          ...
          <div class="p-4 sm:p-6">
            ...
            <a href="/view/testseries/{testseries._id}" class="group mt-4 inline-flex items-center gap-1 text-sm font-medium text-blue-600">
              Find out more
