...
<main class="mt-[67px] bg-white">
    <section class="">
        <div class="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
          <div>
            <h2 class="text-3xl font-bold text-center sm:text-5xl">All About Us</h2>
            <p class="max-w-3xl mx-auto mt-4 text-xl text-center ">Explore Our features that enhance your learning experience and make it even more exciting.</p>
          </div>
            ...
            <div>
              <div class="mt-4 space-y-12">
                <div class="flex">
                  ...
                  <div class="ml-4">
                    <h4 class="text-lg font-medium leadi ">Advanced Learning Technique</h4>
                    <p class="mt-2 ">Discover our improved learning technique that adapt to your preferences and provide even more personalized learning suggestions.</p>
                  </div>
                </div>
                <div class="flex">
                  <div class="flex-shrink-0">
            ...
            <div class="grid grid-cols-3 col-gap-10">
                ...
                <div class="text-center bg-white">
                    ...
                    <div class="p-4">
                        <div class="text-md">
                            <a href="#"
                                class="hover:text-indigo-500 text-gray-900 font-semibold transition duration-500 ease-in-out">Mehdi
                                Mohammadi</a>
            ...
            C93.282,101.457,89.661,116.261,93.282,126.483z"></path>
                ...
                <div class="text-center bg-white">
                    ...
                    <div class="p-4">
                        <div class="text-md">
                            <a href="#"
                                class="hover:text-indigo-500 text-gray-900 font-semibold transition duration-500 ease-in-out">Yahya
                                R. Makarim</a>
            ...
            C93.282,101.457,89.661,116.261,93.282,126.483z"></path>
                ...
                <div class="text-center bg-white">
                    ...
                    <div class="p-4">
                        <div class="text-md">
                            <a href="#"
                                class="hover:text-indigo-500 text-gray-900 font-semibold transition duration-500 ease-in-out">Ahmad
                                Sultani</a>
          ...
          <div class="relative p-4 mt-20 w-96">
            ...
            <div class="px-8 py-4 pt-24 bg-white rounded-lg shadow dark:bg-gray-800">
                <div class="text-center">
                    ...
                    <p class="py-4 mx-auto font-light text-gray-500 text-md  dark:text-gray-400">
                      {@html atob(team.name)}
                    </p>
                </div>
            ...
            <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                <div>
                    ...
                    <div class="mt-5">
                        ...
                        <p class="mt-2 text-base text-gray-500">Our mission is to empower 
                          learners  by providing accessible, high-quality education 
                          that fosters academic excellence, personal growth, and 
                          lifelong learning. We are dedicated to delivering innovative, 
                          personalized education through expert guidance, cutting-edge 
                          technology, and a supportive online community.</p>
                    </div>
                </div>
                <div>
                    <div class="flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
                    ...
                    <div class="mt-5">
                        ...
                        <p class="mt-2 text-base text-gray-500">At Gravity, we are committed to excellence by 
                          delivering the highest quality education through continuous improvement and innovation. We ensure 
                          accessibility by providing flexible and user-friendly learning options for all students, regardless 
                ...
                <div>
                    ...
                    <div class="mt-5">
                        ...
                        <p class="mt-2 text-base text-gray-500">Our vision is to be the
                           leading coaching institute, transforming education 
                           through innovative learning experiences and creating a future 
                           where every learner can achieve their fullest potential. 
                           We aspire to cultivate a world of knowledge, where barriers to 
                           education are removed, and success is attainable for all.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="text-center p-8">
        ...
        <div class="flex flex-wrap items-center mt-20 text-left text-center">
            ...
            <div class="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
                ...
                <p class="sm:text-lg mt-6">
                  Striving for the highest quality in educational content, delivery, and outcomes. Continuously improving and 
                  innovating to ensure the best learning experiences.
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-wrap items-center mt-20 text-left text-center">
            ...
            <div class="w-full md:w-2/5 lg:w-1/2 px-4 md:order-first text-center md:text-left lg:pr-12">
                ...
                <p class="sm:text-lg mt-6">
                  Ensuring that education is available to all, regardless of geographic location, socio-economic status, 
                  or physical ability. Providing flexible learning options to accommodate diverse needs.
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-wrap items-center mt-20 text-left  text-center">
            ...
            <div class="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
                ...
                <p class="sm:text-lg mt-6">
                  Conducting all activities with honesty, transparency, and accountability. Upholding ethical standards
                   in teaching, assessments, and interactions with students...
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-wrap items-center mt-20 text-left text-center">
            ...
            <div class="w-full md:w-2/5 lg:w-1/2 px-4 md:order-first text-center md:text-left lg:pr-12">
                ...
                <p class="sm:text-lg mt-6">
                  Embracing new technologies and methodologies to enhance learning. Encouraging creative problem-solving and 
                  forward-thinking approaches in education.
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-wrap items-center mt-20 text-left text-center">
            ...
            <div class="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
                ...
                <p class="sm:text-lg mt-6">
                  We try to be a friend to the weak child. When a friendship is built, student starts loving his teacher and
                   after that child obeys whatever his teacher says. Here mystery of student’s success lies in understanding 
                   and friendship between teacher and child.
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-wrap items-center mt-20 text-left text-center">
            ...
            <div class="w-full md:w-2/5 lg:w-1/2 px-4 md:order-first text-center md:text-left lg:pr-12">
                ...
                <p class="sm:text-lg mt-6">
                  We all know how helpful it is to remember something that is taught visually to us rather than the one that
                   is read through pages after pages. Just imagine, how beneficial would it be for students to understand a 
                   chapter visually in class. The concept of smart class education is indeed a blessing to the students of the 
                   21st Century. Technology is changing the way life functions and if it’s for the good, then why not go for it!
                </p>
            </div>
        </div>
