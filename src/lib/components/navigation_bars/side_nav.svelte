<nav
  id="sidenav-8"
  class=" shadow-xl absolute left-0 top-0 overflow-scroll z-[1035] m-15 h-full w-60 -translate-x-full overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
  ...
  <a
    ...
    <img
      id="te-logo"
      class="mr-2 px-10"
      src="/images/glogoB.png"
      alt="TE Logo"
      draggable="false" />
    <!-- <span>Tailwind Elements</span> -->
  </a>
  <ul
    class="relative m-0 list-none pb-12"
