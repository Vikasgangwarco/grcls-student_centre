        ...
        <table class="min-w-full">
            <thead>
                <tr>
                    ...
                    <!-- <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Number of Shifts</th> -->
                    <!-- <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Questions</th> -->
                    <!-- <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Stream</th> -->
            ...
            <tbody class="bg-white">
                ...
                <tr>
                    ...
                    <!-- <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900  text-sm leading-5">{exam.question!=null?exam.questions.length:0}</td> -->
                    <!-- <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900  text-sm leading-5">
                        <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                        <span aria-hidden class="absolute inset-0 bg-green-200 opacity-50 rounded-full"></span>
                        <span class="relative text-xs">{exam.class_number}</span>
                    </span>
                    </td> -->
                    <!-- <td class="px-6 py-4 whitespace-no-wrap border-b  text-blue-900 text-sm leading-5">{exam.stream}</td> -->
                    <td class="px-6 py-4 whitespace-no-wrap text-right border-b  text-sm leading-5">
                        <a href="/previous_year_exams/{exam._id}" class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">View</a> 
                    </td>
          </tr>
